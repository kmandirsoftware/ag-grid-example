...
class ScheduleService {
    ...
    getData(connection, request, resultsCallback) {
        ...
        connection.query(SQL, (error, results) => {
            ...
            const pivotFields = ["13th","14th","15th","16th","17th","18th","19th","20th","21st","22nd","23rd","24th","25th"];
    ...
    buildSql(request) {
        ...
        if(request.pivotMode === true){
            SQL = ' select  DATE_FORMAT(Date,"%D") as Date,ClockHour,count(distinct campaign) as UniqueCampaigns from schedule where CampaignEndDate < "2021-06-20" and CampaignEndDate > "2021-05-18" group by Date, ClockHour desc '
            return SQL;
        }

        const selectSql = this.createSelectSql(request);
        const fromSql = ' FROM ldmrk.schedule ';
